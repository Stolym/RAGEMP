...
$(() => {
    $(".tbutton").click(function () {
        switch ($(this).data("id")) {
            case 0:
            radio.current_hertz -= 0.1;
            if (radio.current_hertz < 20)
                radio.current_hertz = 200;
            $(".frequency").text(radio.current_hertz.toFixed(2)+" Hz");
            break;
            case 1:
                radio.current_hertz += 0.1;
                if (radio.current_hertz > 200)
                    radio.current_hertz = 20;
                $(".frequency").text(radio.current_hertz.toFixed(2)+" Hz");
            break;
        }
    });
