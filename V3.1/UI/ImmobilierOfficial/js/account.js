...
function ADD_HISTORY_LIST(data)
{
    for (var i = 0; i < data.history.length; i++) {
        if (data.history[i].gain > 0)
            $(".historyspace").append("<div class='transacttest'><div class='transactionhistoryspace'><p class='transactionhistoryname' style='position: absolute; float: left;'>"+data.name+" "+data.lastname+"</p><p class='transactionhistoryname' style='position: absolute; left: 700px; float: left;'>20/08/2019 08:47</p><p class='transactionhistoryname' style='position: absolute; float: left; left: 1600px; color: #52c495'>"+data.history[i].gain+" $</p></div><p class='transactobject' style='float: left;'>Lieux :</p><p class='transactobject' style='color: #FF8040'>"+data.history[i].lieu+"</p><p class='transactobject'>Object :</p><p class='transactobjectdesc'>"+data.history[i].object+"</p></div>");
        else
            $(".historyspace").append("<div class='transacttest'><div class='transactionhistoryspace'><p class='transactionhistoryname' style='position: absolute; float: left;'>"+data.name+" "+data.lastname+"</p><p class='transactionhistoryname' style='position: absolute; left: 700px; float: left;'>20/08/2019 08:47</p><p class='transactionhistoryname' style='position: absolute; float: left; left: 1600px; color: #FF0000'>"+data.history[i].gain+" $</p></div><p class='transactobject' style='float: left;'>Lieux :</p><p class='transactobject' style='color: #FF8040'>"+data.history[i].lieu+"</p><p class='transactobject'>Object :</p><p class='transactobjectdesc'>"+data.history[i].object+"</p></div>");
    }
}
