...
{
    class EventOrganiz : Events.Script
    {
        public static EventOrganiz instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventOrganiz() { instance = this; }


        public void DebugDrawing(OrganizData data)
        {
        ...
        public void ActiveEvent(OrganizData data)
        {
        }


        public void DesactiveEvent(OrganizData data)
        {
        }
        ...
        public void Draw(OrganizData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(OrganizData data)
        {
        ...
        private void KeyEvent(OrganizData data)
        {
        ...
        private void SwitchTeleport(OrganizData data)
        {
