...
{
    class EventBennysCustom : Events.Script
    {
        public static EventBennysCustom instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventBennysCustom() { instance = this; }


        public void DebugDrawing(BennysCustomData data)
        {
        ...
        public void ActiveEvent(BennysCustomData data)
        {
        }


        public void DesactiveEvent(BennysCustomData data)
        {
        }
        ...
        public void Draw(BennysCustomData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(BennysCustomData data)
        {
        ...
        private void KeyEvent(BennysCustomData data)
        {
        ...
        private void SwitchTeleport(BennysCustomData data)
        {
