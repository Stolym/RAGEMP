...
{
    class EventLost : Events.Script
    {
        public static EventLost instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventLost() { instance = this; }


        public void DebugDrawing(LostData data)
        {
        ...
        public void ActiveEvent(LostData data)
        {
        }


        public void DesactiveEvent(LostData data)
        {
        }
        ...
        public void Draw(LostData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(LostData data)
        {
        ...
        private void KeyEvent(LostData data)
        {
        ...
        private void SwitchTeleport(LostData data)
        {
