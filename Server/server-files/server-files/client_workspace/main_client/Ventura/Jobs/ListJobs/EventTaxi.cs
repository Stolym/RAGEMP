...
{
    class EventTaxi : Events.Script
    {
        public static EventTaxi instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventTaxi() { instance = this; }


        public void DebugDrawing(TaxiData data)
        {
        ...
        public void ActiveEvent(TaxiData data)
        {
        }


        public void DesactiveEvent(TaxiData data)
        {
        }
        ...
        public void Draw(TaxiData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(TaxiData data)
        {
        ...
        private void KeyEvent(TaxiData data)
        {
        ...
        private void SwitchTeleport(TaxiData data)
        {
