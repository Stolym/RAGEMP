...
{
    class EventBario : Events.Script
    {
        public static EventBario instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventBario() { instance = this; }


        public void DebugDrawing(BarioData data)
        {
        ...
        public void ActiveEvent(BarioData data)
        {
        }


        public void DesactiveEvent(BarioData data)
        {
        }
        ...
        public void Draw(BarioData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(BarioData data)
        {
        ...
        private void KeyEvent(BarioData data)
        {
        ...
        private void SwitchTeleport(BarioData data)
        {
