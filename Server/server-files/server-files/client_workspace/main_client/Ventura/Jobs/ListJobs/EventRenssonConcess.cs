...
{
    class EventRenssonConcess : Events.Script
    {
        public static EventRenssonConcess instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventRenssonConcess() { instance = this; }


        public void DebugDrawing(RenssonConcessData data)
        {
        ...
        public void ActiveEvent(RenssonConcessData data)
        {
        }


        public void DesactiveEvent(RenssonConcessData data)
        {
        }
        ...
        public void Draw(RenssonConcessData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(RenssonConcessData data)
        {
        ...
        private void KeyEvent(RenssonConcessData data)
        {
        ...
        private void SwitchTeleport(RenssonConcessData data)
        {
