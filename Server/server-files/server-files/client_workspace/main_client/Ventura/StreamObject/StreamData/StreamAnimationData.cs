...
{
    class StreamAnimationData : Events.Script
    {
        private string event_name = main_client.Ventura.Constant.Constant.table_event_name[((int)main_client.Ventura.Constant.Constant.UpdateFlagsClient.WorldAnimationData >> 2) - 1];
        ...
        {
            //Chat.Output("Ultim Async Animation");
        ...
        private void PlayerStreamIn(A.Player player, string json)
        {
            ...
            JsonConvert.DeserializeObject<StreamObject.WorldData.WorldAnimationData>(json).StreamIn();
            active_tick = true;
        }
