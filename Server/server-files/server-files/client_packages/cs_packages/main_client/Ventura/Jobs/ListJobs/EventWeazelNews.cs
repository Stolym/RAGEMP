...
{
    class EventWeazelNews : Events.Script
    {
        public static EventWeazelNews instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventWeazelNews() { instance = this; }


        public void DebugDrawing(WeazelNewsData data)
        {
        ...
        public void ActiveEvent(WeazelNewsData data)
        {
        }


        public void DesactiveEvent(WeazelNewsData data)
        {
        }
        ...
        public void Draw(WeazelNewsData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(WeazelNewsData data)
        {
        ...
        private void KeyEvent(WeazelNewsData data)
        {
        ...
        private void SwitchTeleport(WeazelNewsData data)
        {
