...
{
    class EventBrinks : Events.Script
    {
        public static EventBrinks instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventBrinks() { instance = this; }


        public void DebugDrawing(BrinksData data)
        {
        ...
        public void ActiveEvent(BrinksData data)
        {
        }


        public void DesactiveEvent(BrinksData data)
        {
        }
        ...
        public void Draw(BrinksData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(BrinksData data)
        {
        ...
        private void KeyEvent(BrinksData data)
        {
        ...
        private void SwitchTeleport(BrinksData data)
        {
