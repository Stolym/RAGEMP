...
{
    class EventNigloTattoo : Events.Script
    {
        public static EventNigloTattoo instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventNigloTattoo() { instance = this; }


        public void DebugDrawing(NigloTattooData data)
        {
        ...
        public void ActiveEvent(NigloTattooData data)
        {
        }


        public void DesactiveEvent(NigloTattooData data)
        {
        }
        ...
        public void Draw(NigloTattooData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(NigloTattooData data)
        {
        ...
        private void KeyEvent(NigloTattooData data)
        {
        ...
        private void SwitchTeleport(NigloTattooData data)
        {
