...
{
    class EventBlackKnight : Events.Script
    {
        public static EventBlackKnight instance = null;
        private float distance = 10f;
        private byte state = 0x00;
        private long ticks = 0;

        public EventBlackKnight() { instance = this; }


        public void DebugDrawing(BlackKnightData data)
        {
        ...
        public void ActiveEvent(BlackKnightData data)
        {
        }


        public void DesactiveEvent(BlackKnightData data)
        {
        }
        ...
        public void Draw(BlackKnightData obj = null)
        {
            StartClock();
            if (obj == null)
                return;
        ...
        private bool CheckIfBindKeyEvent(BlackKnightData data)
        {
        ...
        private void KeyEvent(BlackKnightData data)
        {
        ...
        private void SwitchTeleport(BlackKnightData data)
        {
