...
{
    class StreamBodyData : Events.Script
    {
        private string event_name = main_client.Ventura.Constant.Constant.table_event_name[((int)main_client.Ventura.Constant.Constant.UpdateFlagsClient.WorldBodyData >> 2) - 1];
        private string data_name = main_client.Ventura.Constant.Constant.table_data_name[((int)main_client.Ventura.Constant.Constant.UpdateFlagsClient.WorldBodyData >> 2) - 1];
        ...
        private void PlayerStreamIn(A.Player player, string json)
        {
            ...
            JsonConvert.DeserializeObject<StreamObject.WorldData.WorldBodyData>(json).StreamIn();
            active_tick = true;
        }
